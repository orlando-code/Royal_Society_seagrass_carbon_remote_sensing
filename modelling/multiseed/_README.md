...
- `train_test_fraction_diagnostic.R`: fold-size and target-variance diagnostics joined to robust evaluation results; writes under `sensitivity_suite/` (`sensitivity_train_test_fraction_*.csv`) and `sensitivity_suite/plots/`.
